...
interface IdUploadFrontProps {
  onUpdate: (image: string | null) => void
  onNext: () => void
  onPrevious: () => void
}

export function IdUploadFront({ onUpdate, onNext, onPrevious }: IdUploadFrontProps) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-semibold">Upload ID Front</h2>
        <p className="text-gray-500">Please upload a clear photo of the front of your ID</p>
      </div>
      ...
      {!image ? (
        ...
        <div className="space-y-4">
          <div className="relative aspect-[3/2] w-full overflow-hidden rounded-lg border">
            <img src={image || "/placeholder.svg"} alt="ID Front" className="h-full w-full object-contain" />
          </div>
